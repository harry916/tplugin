...
////        OpenOrderGetRequest                                           req=new OpenOrderGetRequest();
//        req.setOrderId(10020L);
...
//        OpenOrderGetResponse response = client.execute(req);
        ...
        storeService.updateStore(new Store("022", "hello", "word", 22339));
        List<Store> a = storeService.findAllStore();
        if (a != null)
